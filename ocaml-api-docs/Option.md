# Module [Option](type_Option.html)


```
module Option: sig [..](Option.html) end
```
...
```
val to_result : none:'e -> 'a option -> ('a, 'e) [result](Stdlib.html#TYPEresult)
```
...
```
val to_seq : 'a option -> 'a [Seq.t](Seq.html#TYPEt)
```
